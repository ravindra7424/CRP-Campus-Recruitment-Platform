<?php
    ...
    if (isset($_POST["update"])) {
        ...
        $sql = "SELECT * FROM com_users WHERE email = '{$_SESSION['email']}'";
        ...
        if ($cur_pass == $pass)
        {
            $sql = "UPDATE com_users SET password='$new_pass' WHERE email='{$_SESSION['email']}'";
            $result = mysqli_query($conn, $sql);
...
<html lang="en" dir="ltr">
   <head>
      ...
      <link rel="stylesheet" href="com_settings.css">
